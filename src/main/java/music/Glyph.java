...
public class Glyph{
    /**
     *Each Glyph instance represents a specific musical symbol, characterized by:
     *
     * code: A Unicode character corresponding to a specific musical symbol in the font.
     * scale: Scale factor for the glyph size relative to a base height.
     * dx and dy: Horizontal (dx) and vertical (dy) offsets for positioning the glyph.
     */
    ...
    public static Glyph CLEF_G = new Glyph((char)61479, 16, -3, 1);//Treble Clef
    ...
    public static Glyph HEAD_HALF = new Glyph((char)61485, 16, 0, 7);//Half Note Head
    public static Glyph HEAD_Q = new Glyph((char)61486, 16, 0, 7);//Quarter Note Head
    public static Glyph HEAD_W = new Glyph((char)61484, 16, 0, 7);//Whole Note Head
